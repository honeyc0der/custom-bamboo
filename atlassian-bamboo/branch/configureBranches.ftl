        ...
        [@ww.form action='updateBranches'
            ...
            [#if action.branchDetectionCapable]
                ...
                [@ui.bambooSection titleKey='chain.config.branches.detection.title' description=branchDetectionDescription]
                    ...
                    [#if pullRequestAware && createBranchesForPullRequestsEnabled]
                        [@ww.checkbox labelKey='chain.config.branches.pullrequests.build' name='buildPullRequests' /]
                    [/#if]
                [/@ui.bambooSection]
            [#else]
            ...
            [#assign inactivityDescription]
            <span class="aui-form">[@ww.text name="chain.config.branches.autoClean.days.desc"/]</span>[/#assign]
            [@ui.bambooSection titleKey='chain.config.branches.autoClean' descriptionKey="chain.config.branches.autoClean.description" headerWeight='h3']
