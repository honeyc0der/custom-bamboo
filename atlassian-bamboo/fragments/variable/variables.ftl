...
[#macro configureVariables id variablesList createVariableUrl deleteVariableUrl updateVariableUrl overriddenVariablesMap tableId availableVariables=[] globalNotOverriddenVariables=[]]
    ...
    <script type="text/javascript">
        BAMBOO.VARIABLES.VariablesConfigurationForm({
            ...
            overriddenVariablesMap: jQuery.parseJSON("${action.toJson(overriddenVariablesMap)?js_string}"),
            globalNotOverriddenVariables: jQuery.parseJSON("${action.toJson(globalNotOverriddenVariables)?js_string}")
        });
    </script>
[/#macro]
            ...
            [#elseif globalNotOverriddenVariables?has_content]
                ...
                <script>
                    new BAMBOO.VariableSingleSelect({
                        el: '#variableKey',
                        bootstrap: jQuery.parseJSON("${action.toJson(globalNotOverriddenVariables)?js_string}")
                    });
                </script>
            [#else]
