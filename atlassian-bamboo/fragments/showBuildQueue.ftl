                    ...
                    <li class="on">
                        ...
                        <ul class="queueActions">
                            ...
                            <li id="currentlyBuildingActions">
                                ...
                                [#else]
                                    <a class="internalLink build-stop" href="[@ww.url action='stopPlan.action' namespace='build/admin' planKey=buildId.planKey returnUrl=returnUrl /]">[@ui.icon type="build-stop" textKey="agent.build.cancel" /]</a>
                                [/#if]
                            </li>
                            [/#if]
                        </ul>
                    ...
                    [#if fn.hasPlanPermission('READ', buildContext.planKey) ]
                        ...
                        <li class="queueItem[#if reorderedBuildKey?? && buildContext.planKey = reorderedBuildKey] reorderedBuild[/#if]">
                            ...
                            [#if fn.hasPlanPermission('BUILD', buildContext.planKey) ]
                                <li><a class="internalLink build-stop" href="[@ww.url action='stopPlan.action' namespace='build/admin' planKey=buildContext.planKey returnUrl=returnUrl /]">[@ui.icon type="build-stop" textKey="queue.delete.from" /]</a></li>
                            [/#if]
                            </ul>
                            <p class="queueStatus">
                                [#if currentlyBuilding?has_content]
