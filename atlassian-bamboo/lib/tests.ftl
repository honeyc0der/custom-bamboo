                                ...
                                <td class="actions">
                                    ...
                                    [@ui.standardMenu triggerText="" id="${id}-testResultActions-${testResult.testCase.id}" icon="configure" useIconFont=true subtle=true]
                                        ...
                                        [#if showQuarantineActions && action.testQuarantineEnabled]
                                            [@displayTestQuarantineActions testResult=testResult returnUrl=currentUrl /]
                                        [/#if]
...
[#macro displayTestQuarantineActions testResult returnUrl]
[#-- @ftlvariable name="testResult" type="com.atlassian.bamboo.resultsummary.tests.TestCaseResult" --]
        [@ww.url id="quarantineUrl" action="quarantineTest" namespace="/build/admin" testId=testResult.testCase.id returnUrl=returnUrl /]
        [@ww.url id="unleashUrl" action="unleashTest" namespace="/build/admin" testId=testResult.testCase.id returnUrl=returnUrl /]
        ...
        [@ui.displayLink
            ...
            extraAttributes={"data-quarantine-url":quarantineUrl, "data-unleash-url":unleashUrl}
